...
CLOVE_TEST(ReadQuadObj)
{
   ...
   // face 1
   CLOVE_INT_EQ(3, obj->v_info[0].v_index);
   CLOVE_INT_EQ(3, obj->v_info[0].vt_index);
   CLOVE_INT_EQ(0, obj->v_info[0].vn_index);

   CLOVE_INT_EQ(2, obj->v_info[1].v_index);
   CLOVE_INT_EQ(2, obj->v_info[1].vt_index);
   CLOVE_INT_EQ(0, obj->v_info[1].vn_index);

   CLOVE_INT_EQ(0, obj->v_info[2].v_index);
   CLOVE_INT_EQ(1, obj->v_info[2].vt_index);
   CLOVE_INT_EQ(0, obj->v_info[2].vn_index);

   // face 2
   CLOVE_INT_EQ(1, obj->v_info[3].v_index);
   CLOVE_INT_EQ(0, obj->v_info[3].vt_index);
   CLOVE_INT_EQ(0, obj->v_info[3].vn_index);

   CLOVE_INT_EQ(3, obj->v_info[4].v_index);
   CLOVE_INT_EQ(3, obj->v_info[4].vt_index);
   CLOVE_INT_EQ(0, obj->v_info[4].vn_index);

   CLOVE_INT_EQ(0, obj->v_info[5].v_index);
   CLOVE_INT_EQ(1, obj->v_info[5].vt_index);
   CLOVE_INT_EQ(0, obj->v_info[5].vn_index);
